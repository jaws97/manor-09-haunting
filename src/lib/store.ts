...
/**
 * Minimal external store for browser-only state (clock, localStorage, polling).
 * `start` runs when the first component subscribes and its cleanup when the
 * last one leaves. Server render and hydration see `initial`.
 */
