...
/**
 * Client view of the show. Only /screen and /host subscribe, and they poll —
 * a few tiny requests a second that survive flaky venue Wi-Fi far better than
 * a socket, and leave realtime connection limits untouched.
 */
const POLL_MS = 450;
